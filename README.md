...
- [Quick Start](#quick-start)
	- [The relation of IoTDB and Benchmark with version](#The relation of IoTDB and Benchmark with version)
		- [IoTDB 0.10.0](#When the version of IoTDB is master(0.10.0) , you have to use the branch rel/0.10 of benchmark to test it.)
		- [IoTDB 0.9.0](#When the version of IoTDB is not master(0.9.0) , you have to use the branch rel/0.9 of benchmark to test it.)
